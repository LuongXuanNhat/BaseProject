        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Searchs_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NoticeDetails", x => new { x.NotificationId, x.UserId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_NoticeDetails_Notifications_NotificationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CategoriesDetails_AspNetUsers_AppUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Saveds_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "HomeDescription", "Đây là mô tả của Web_Review" },
                    { "HomeKeyWord", "Đây là từ khóa của Web_Review" },
                    { "HomeTitle", "Đây là trang chủ của Web_Review" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoriesDetails_AppUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LocationsDetails_AppUserId",
